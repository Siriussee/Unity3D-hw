...
namespace Com.Mygame
{
    ...
    //SceneController 的接口，在 MyFirstController.cs 中 MyFirstController类被实现
    //用于加载场景对象（也可以切换场景/暂停什么的）
    ...
    //给游戏对象挂载，控制器可以调用 setDestination 实现移动 
    //应该作为接口实现
    ...
    //角色控制器，用于实例化预设，加载点击监听器
    public class MyCharacterController
    {
        readonly GameObject character;
        readonly Moveable moveableScript;
        readonly MyClickGUI clickGUI;
        ...
        public MyCharacterController(string which_character)
        {
            ...
            clickGUI = character.AddComponent(typeof(MyClickGUI)) as MyClickGUI;
        ...
        public void reset()
        {
            ...
            coastController = (Director.getInstance().currentSceneController as MyFirstController).fromCoast;
    ...
    public class BoatController
    {
        ...
        public BoatController()
        {
            ...
            clickGUI = boat.AddComponent(typeof(MyClickGUI)) as MyClickGUI;
        }
