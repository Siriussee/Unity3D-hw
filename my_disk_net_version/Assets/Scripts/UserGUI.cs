	...
	void OnGUI ()
    {
        ...
        if (game_start)
        {
            ...
            if (life == 0)
            {
                ...
                GUI.Label(new Rect(Screen.width / 2 - 120, Screen.width / 2 - 250, 100, 100), "GAME OVER", over_style);
                GUI.Label(new Rect(Screen.width / 2 - 110, Screen.width / 2 - 200, 50, 50), "Final Scores:", text_style);
        ...
        {
            GUI.Label(new Rect(Screen.width / 2 - 100, Screen.width / 2 - 350, 100, 100), "Shoot Disks!", over_style);
            GUI.Label(new Rect(Screen.width / 2 - 150, Screen.width / 2 - 220, 400, 100), "Click disks to shoot them down. You have only 6 chances to miss.", text_style);
